                    ...
                    <div class="col-md-12" style="border-right: 1px dotted #C2C2C2;padding-right: 30px;">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="Login">
                                <form role="form" class="form-horizontal" action="login.php?loginid=1" method="post">
			...
			<li>
				...
				<div class="date-city">
					...
					<div class="buy-tickets">
						<a href="movie-select-show.php?id= <?php echo $row['eventid']; ?>">BUY TICKETS</a>  
					</div>
				</div>
			</li>
			<li>
